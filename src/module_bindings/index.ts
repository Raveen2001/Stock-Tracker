...
import StockPriceRow from "./stock_price_table";
import WatchlistItemRow from "./watchlist_item_table";
...
const tablesSchema = __schema({
  ...
  stockPrice: __table({
    name: 'stock_price',
    indexes: [
      { accessor: 'symbol', name: 'stock_price_symbol_idx_btree', algorithm: 'btree', columns: [
        'symbol',
      ] },
    ],
    constraints: [
      { name: 'stock_price_symbol_key', constraint: 'unique', columns: ['symbol'] },
    ],
  }, StockPriceRow),
  watchlistItem: __table({
    name: 'watchlist_item',
    indexes: [
      { accessor: 'id', name: 'watchlist_item_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'watchlist_item_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, WatchlistItemRow),
});
...
const proceduresSchema = __procedures(
  ...
  __procedureSchema("get_my_account_id", GetMyAccountIdProcedure.params, GetMyAccountIdProcedure.returnType),
